if (WITH_RANDOMX)
    add_definitions(/DKITTENPAW_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (WITH_ASM AND NOT KITTENPAW_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (KITTENPAW_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (WITH_MSR AND NOT KITTENPAW_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (KITTENPAW_OS_WIN OR KITTENPAW_OS_LINUX))
        add_definitions(/DKITTENPAW_FEATURE_MSR)
        add_definitions(/DKITTENPAW_FIX_RYZEN)
        message("-- WITH_MSR=ON")
        ...
        remove_definitions(/DKITTENPAW_FEATURE_MSR)
        remove_definitions(/DKITTENPAW_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()

    if (WITH_PROFILING)
        add_definitions(/DKITTENPAW_FEATURE_PROFILING)

        list(APPEND HEADERS_CRYPTO src/crypto/rx/Profiler.h)
        list(APPEND SOURCES_CRYPTO src/crypto/rx/Profiler.cpp)
    endif()
else()
    remove_definitions(/DKITTENPAW_ALGO_RANDOMX)
endif()
