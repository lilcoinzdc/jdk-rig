...
#ifndef KITTENPAW_MM_MALLOC_PORTABLE_H
#define KITTENPAW_MM_MALLOC_PORTABLE_H


#if defined(KITTENPAW_ARM) && !defined(__clang__)
#include <stdlib.h>
...
#endif /* KITTENPAW_MM_MALLOC_PORTABLE_H */
