...
bool kittenpaw::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool kittenpaw::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t kittenpaw::LinuxMemory::read(const char *path)
{
