...
bool jdkrig::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool jdkrig::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t jdkrig::LinuxMemory::read(const char *path)
{
