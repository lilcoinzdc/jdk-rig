...
kittenpaw::ProxyUrl::ProxyUrl(const rapidjson::Value &value)
{
    m_port = 0;
...
const kittenpaw::String &kittenpaw::ProxyUrl::host() const
{
    return m_host.isNull() && isValid() ? kLocalhost : m_host;
}


rapidjson::Value kittenpaw::ProxyUrl::toJSON(rapidjson::Document &doc) const
{
