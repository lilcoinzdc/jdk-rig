...
#ifndef KITTENPAW_CLIENT_H
#define KITTENPAW_CLIENT_H
...
{
public:
    KITTENPAW_DISABLE_COPY_MOVE_DEFAULT(Client)
...
protected:
    ...
    std::string make_donut_name(const char* method);
