...
kittenpaw::DnsRecord::DnsRecord(const addrinfo *addr) :
...
const sockaddr *kittenpaw::DnsRecord::addr(uint16_t port) const
{
...
kittenpaw::String kittenpaw::DnsRecord::ip() const
{
    char *buf = nullptr;
