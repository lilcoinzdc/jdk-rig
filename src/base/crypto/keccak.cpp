...
void kittenpaw::keccakf(uint64_t st[25], int rounds)
{
...
void kittenpaw::keccak(const uint8_t *in, int inlen, uint8_t *md, int mdlen)
{
    state_t st;
    ...
    for ( ; inlen >= rsiz; inlen -= rsiz, in += rsiz) {
        ...
        kittenpaw::keccakf(st, KECCAK_ROUNDS);
    }
