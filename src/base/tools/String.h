...
#ifndef KITTENPAW_STRING_H
#define KITTENPAW_STRING_H
 ...
 * 2. For some reason I prefer don't use std:string in kittenpawger, eg because of file size of MSYS2 builds.
