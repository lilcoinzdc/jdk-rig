...
#ifndef KITTENPAW_BLOCKTEMPLATE_H
#define KITTENPAW_BLOCKTEMPLATE_H
...
#   endif
    ...
    enum Offset : uint32_t {
        NONCE_OFFSET,
        KITTENPAWGER_TX_PREFIX_OFFSET,
        KITTENPAWGER_TX_PREFIX_END_OFFSET,
    ...
    // Wownero kittenpawger signature
    inline bool hasKittenpawgerSignature() const                   { return !m_kittenpawgerSignature.empty(); }
    inline const Span &kittenpawgerSignature() const               { return m_kittenpawgerSignature; }
    ...
    inline const Buffer &kittenpawgerTxMerkleTreeBranch() const    { return m_kittenpawgerTxMerkleTreeBranch; }
    ...
    static void calculateKittenpawgerTxHash(const uint8_t *prefix_begin, const uint8_t *prefix_end, uint8_t *hash);
    static void calculateRootHash(const uint8_t *prefix_begin, const uint8_t *prefix_end, const Buffer &kittenpawger_tx_merkle_tree_branch, uint8_t *root_hash);
...
#endif /* KITTENPAW_BLOCKTEMPLATE_H */
