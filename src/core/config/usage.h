...
#ifndef JDKRIG_USAGE_H
#define JDKRIG_USAGE_H
...
//     u += "  -o, --url=URL                 URL of jdkrigging server\n";
//     u += "  -a, --algo=ALGO               jdkrigging algorithm https://jdkrig.com/docs/algorithms\n";
//     u += "      --coin=COIN               specify coin instead of algorithm\n";
//     u += "  -u, --user=USERNAME           username for jdkrigging server\n";
//     u += "  -p, --pass=PASSWORD           password for jdkrigging server\n";
//     u += "  -O, --userpass=U:P            username:password pair for jdkrigging server\n";
...
//     u += "      --daemon                  use daemon RPC instead of pool for solo jdkrigging\n";
...
//     u += "      --donate-over-proxy=N     control donate over jdkrig-proxy feature\n";
//
//     u += "\nCPU backend:\n";
//
//     u += "      --no-cpu                  disable CPU jdkrigging backend\n";
...
//     u += "\nOpenCL backend:\n";
//     u += "      --opencl                  enable OpenCL jdkrigging backend\n";
...
//     u += "\nCUDA backend:\n";
//     u += "      --cuda                    enable CUDA jdkrigging backend\n";
//     u += "      --cuda-loader=PATH        path to CUDA plugin (jdkrig-cuda.dll or libjdkrig-cuda.so)\n";
...
//     u += "  -B, --background              run the jdkrigger in the background\n";
