...
#ifndef KITTENPAW_USAGE_H
#define KITTENPAW_USAGE_H
...
//     u += "  -o, --url=URL                 URL of kittenpawging server\n";
//     u += "  -a, --algo=ALGO               kittenpawging algorithm https://kittenpaw.com/docs/algorithms\n";
//     u += "      --coin=COIN               specify coin instead of algorithm\n";
//     u += "  -u, --user=USERNAME           username for kittenpawging server\n";
//     u += "  -p, --pass=PASSWORD           password for kittenpawging server\n";
//     u += "  -O, --userpass=U:P            username:password pair for kittenpawging server\n";
...
//     u += "      --daemon                  use daemon RPC instead of pool for solo kittenpawging\n";
...
//     u += "      --donate-over-proxy=N     control donate over kittenpaw-proxy feature\n";
//
//     u += "\nCPU backend:\n";
//
//     u += "      --no-cpu                  disable CPU kittenpawging backend\n";
...
//     u += "\nOpenCL backend:\n";
//     u += "      --opencl                  enable OpenCL kittenpawging backend\n";
...
//     u += "\nCUDA backend:\n";
//     u += "      --cuda                    enable CUDA kittenpawging backend\n";
//     u += "      --cuda-loader=PATH        path to CUDA plugin (kittenpaw-cuda.dll or libkittenpaw-cuda.so)\n";
...
//     u += "  -B, --background              run the kittenpawger in the background\n";
