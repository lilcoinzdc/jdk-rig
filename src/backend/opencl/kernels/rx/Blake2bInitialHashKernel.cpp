...
void jdkrig::Blake2bInitialHashKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void jdkrig::Blake2bInitialHashKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void jdkrig::Blake2bInitialHashKernel::setBlobSize(size_t size)
{
...
void jdkrig::Blake2bInitialHashKernel::setNonce(uint32_t nonce)
{
