...
void kittenpaw::Blake2bInitialHashBigKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void kittenpaw::Blake2bInitialHashBigKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void kittenpaw::Blake2bInitialHashBigKernel::setBlobSize(size_t size)
{
...
void kittenpaw::Blake2bInitialHashBigKernel::setNonce(uint32_t nonce, uint32_t nonce_offset)
{
