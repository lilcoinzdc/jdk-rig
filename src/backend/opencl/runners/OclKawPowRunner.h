...
#ifndef KITTENPAW_OCLKAWPOWRUNNER_H
#define KITTENPAW_OCLKAWPOWRUNNER_H
...
{
public:
    KITTENPAW_DISABLE_COPY_MOVE_DEFAULT(OclKawPowRunner)
...
#endif // KITTENPAW_OCLKAWPOWRUNNER_H
