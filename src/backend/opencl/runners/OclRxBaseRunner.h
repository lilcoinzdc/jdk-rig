...
#ifndef KITTENPAW_OCLRXBASERUNNER_H
#define KITTENPAW_OCLRXBASERUNNER_H
...
{
public:
    KITTENPAW_DISABLE_COPY_MOVE_DEFAULT(OclRxBaseRunner)
...
#endif // KITTENPAW_OCLRXBASERUNNER_H
