:: Example batch file for kittenpawging Monero solo
::
:: Format:
::	kittenpaw.exe -o <node address>:<node port> -a rx/0 -u <wallet address> --daemon
::
:: Fields:
...
cd /d "%~dp0"
kittenpaw.exe -o YOUR_NODE_IP:18081 -a rx/0 -u 48edfHu7V9Z84YzzMa6fUueoELZ9ZRXq9VetWzYGzKt52XU5xvqgzYnDK9URnRoJMk1j8nLwEVsaSWJ4fhdUyZijBGUicoD --daemon
pause
