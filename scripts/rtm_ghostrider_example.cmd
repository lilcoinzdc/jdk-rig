:: Example batch file for jdkrigging Raptoreum at a pool
::
:: Format:
::      jdkrig.exe -a gr -o <pool address>:<pool port> -u <pool username/wallet> -p <pool password>
::
:: Fields:
...
::
:: List of Raptoreum jdkrigging pools:
::      https://jdkriggingpoolstats.stream/raptoreum
::
...
jdkrig.exe -a gr -o raptoreumemporium.com:3008 -u WALLET_ADDRESS -p x
:: Or use this command line to connect to an SSL port
:: jdkrig.exe -a gr -o rtm.suprnova.cc:4273 --tls -u WALLET_ADDRESS -p x
pause
